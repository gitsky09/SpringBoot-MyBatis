...
//    		.loginProcessingUrl("/userlogin");
        ...
        // [登入設定2]若有設定loginPage則該URL的post方法為登入作用，亦能自定義loginProcessingUrl來處理Post請求
        // [登入設定3]讓對應的Parameter在自訂登入頁使用
...
//		super.configure(auth);
		...
		.and()
		.withUser("chad").password(passwordEncoder().encode("123456")).roles("admin", "manager")
		.and()
